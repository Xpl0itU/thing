...
// offsets is hardcoded for A12-14!!! Change it for your device!!!
    ...
    // Code taken from https://github.com/brandonplank/PlankFilza/blob/main/PlankFilza/postexploit/rootless.m
    cicuta_log("Escaping sandbox.");
    ...
    cicuta_log("PAC decrypt: 0x%llx -> 0x%llx", cr_label_pac, cr_label);
